      ...
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 6, pt: 8 }}>
          ...
          >
            ...
            >
              Discover our carefully curated packages designed to give you the best experience of Gulmarg and its surroundings
            </Typography>
          </motion.div>
          ...
          <Paper elevation={1} sx={{ 
            ...
            >
              <Tab label="All Packages" value="all" />
              <Tab label="Adventure" value="adventure" />
              <Tab label="Relaxation" value="relaxation" />
              <Tab label="Cultural" value="cultural" />
              <Tab label="Family" value="family" />
              <Tab label="Couples" value="couples" />
            </Tabs>
          </Paper>
        </Box>
        ...
        {selectedPackageData && (
          <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            <Box sx={{ position: 'relative', height: 300, flexShrink: 0 }}>
              <CardMedia
                component="img"
                image={selectedPackageData.image}
                alt={selectedPackageData.title}
                sx={{ 
                  height: '100%',
                  width: '100%',
                  objectFit: 'cover'
              ...
              >
                ...
                <Box sx={{ display: 'flex', gap: 3, alignItems: 'center' }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    {selectedPackageData.location}
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <StarIcon sx={{ mr: 1, color: theme.palette.secondary.main }} />
                    {selectedPackageData.rating}/5 ({selectedPackageData.reviews} reviews)
                  </Box>
                </Box>
              </Box>
            </Box>
                  ...
                  >
                    ...
                    <List dense>
                      <ListItem disableGutters>
                        ...
                        <ListItemText 
                          primary="Duration"
                          secondary={selectedPackageData.duration}
                        />
                      </ListItem>
                      <ListItem disableGutters>
                        <ListItemIcon sx={{ minWidth: 36 }}>
                        ...
                        <ListItemText 
                          primary="Location"
                          secondary={selectedPackageData.location}
                        />
                      </ListItem>
                      <ListItem disableGutters>
                        <ListItemIcon sx={{ minWidth: 36 }}>
                        ...
                        <ListItemText 
                          primary="Rating"
                          secondary={`${selectedPackageData.rating}/5 (${selectedPackageData.reviews} reviews)`}
                        />
                      </ListItem>
                    </List>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        handleOpenDialog(selectedPackageData.id);
                      }}
                      sx={{ mt: 3 }}
                    >
                      Book Now
        ...
        <DialogTitle>
          <Box display="flex" justifyContent="space-between" alignItems="center">
            <Typography variant="h5" component="div" fontWeight="bold">
              Book {selectedPackageData?.title}
            </Typography>
              ...
              <Grid item xs={12}>
                <Box sx={{ display: 'flex', alignItems: 'center', p: 2, bgcolor: 'primary.light', borderRadius: 1, mt: 1 }}>
                  ...
                  <Typography variant="body2" color="primary.main" fontWeight="medium">
                    Package Price: <strong>{selectedPackageData?.price}</strong> per person
                  </Typography>
                </Box>
              </Grid>
